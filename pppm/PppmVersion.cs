...
namespace pppm
{
    ...
    public struct VersionRequirement
    {
        ...
        /// </summary>
        public PppmVersion MinimalVersion;

        /// <summary>
        /// True if associated entity is compatible with currently running pppm
        /// </summary>
        public bool VersionValid => MinimalVersion <= Pppm.Version;
    }
    ...
    public struct PppmVersion
    {
        ...
        /// <returns></returns>
        public delegate bool VersionCompare(PppmVersion a, PppmVersion b);
        ...
        /// <summary>
        /// Try parsing a string as <see cref="PppmVersion"/>
        /// </summary>
        ...
        public static bool TryParse(string input, out PppmVersion version, MissingInferenceDelegate inference = null)
        {
            version = new PppmVersion(0, inference: inference);
        ...
        /// <summary>
        /// Huge breaking changes, totally different software. <see cref="PppmVersion"/> must have
        ...
        /// <summary>
        /// Construct an <see cref="PppmVersion"/> out of a <see cref="Version"/>
        /// </summary>
        /// <param name="v"></param>
        public PppmVersion(Version v)
        {
            _major = v.Major;
            _minor = v.Minor;
            _build = v.Build;
        ...
        public PppmVersion(int major, int? minor = null, int? build = null, int? revision = null, MissingInferenceDelegate inference = null) : this()
        {
            _major = major;
            _minor = minor;
            _build = build;
        ...
        /// <summary>
        /// Creates a traditional <see cref="Version"/> out of this <see cref="PppmVersion"/>
        /// </summary>
        /// <returns></returns>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is PppmVersion other && other.ToVersion().Equals(ToVersion());
        }
        ...
        public static PppmVersion operator +(PppmVersion a, PppmVersion b) => new PppmVersion(
            a._major + b._major,
            (a._minor ?? 0) + b._minor,
            (a._build ?? 0) + b._build,
        ...
        public static bool operator <(PppmVersion a, PppmVersion b) => a.ToVersion() < b.ToVersion();
        public static bool operator >(PppmVersion a, PppmVersion b) => a.ToVersion() > b.ToVersion();
        public static bool operator <=(PppmVersion a, PppmVersion b) => a.ToVersion() <= b.ToVersion();
        public static bool operator >=(PppmVersion a, PppmVersion b) => a.ToVersion() >= b.ToVersion();
        public static bool operator ==(PppmVersion a, PppmVersion b) => a.ToVersion() == b.ToVersion();
